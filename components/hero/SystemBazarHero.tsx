      ...
      <div className="relative mx-auto flex w-full max-w-5xl flex-col gap-6 px-4 py-16 text-right" dir="rtl">
        ...
        <div className="space-y-4">
          <h1 className="text-3xl font-bold leading-tight text-slate-50 sm:text-4xl lg:text-5xl">
            دیدن سیستم‌ها، یادگرفتن اندازه‌گیری، تصمیم‌گرفتن در موج پنج.
          </h1>

          <p className="max-w-2xl text-sm leading-relaxed text-slate-300 ml-auto">
            systembazar یک مدرسه و بازارِ بسته‌های سیستم‌سازی است.
            برای هر مسئله مدیریتی، به تیم‌تان یک بسته سیستم می‌دهد: نقشهٔ سیستم، سنجه‌های واقعی و راهنمای اجرا.
            ارزش اصلی؟ اینکه قبل از تصمیم، سیستم‌تان را می‌بینید و می‌سنجید.
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center justify-end gap-3">
          ...
          >
            آشنایی با بسته‌های سیستم‌سازی
          </Link>
        </div>

        <p className="text-[11px] text-slate-400 text-right">
          کمتر از ۵ دقیقه، یک تصویر کلی از سیستم فعلی تیم‌تان بگیرید.
        </p>
