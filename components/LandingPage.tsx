        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            {measurementQuotes.map((quote) => (
              ...
              >
                <div className="flex flex-col gap-2">
                  <p className="text-sm md:text-base leading-relaxed text-right text-slate-100">{quote.translation}</p>
                  <p className="text-xs text-slate-400 text-right">{quote.name}</p>
                  <p className="mt-2 text-[11px] text-slate-500 text-left" dir="ltr">
                    {quote.original}
                  </p>
                </div>
              </div>
